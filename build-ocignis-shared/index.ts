// Tree shaking can cause potential issues with tsup when generating .js (not types declaration) files,
// try to export files by exact file path where export is located.
// https://github.com/egoist/tsup/issues/578
